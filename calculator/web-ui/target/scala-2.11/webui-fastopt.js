...
var $c_Lcalculator_Calculator$ = (function() {
  $c_O.call(this);
  this.calculator$Calculator$$stackSet$1 = null
});
...
$c_Lcalculator_Calculator$.prototype.init___ = (function() {
  ...
  this.calculator$Calculator$$stackSet$1 = $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  return this
});
...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  return $as_sci_Map($s_sci_MapLike$class__transform__sci_MapLike__F2__scg_CanBuildFrom__O(namedExpressions, f, bf))
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Ref(x1)) {
      ...
      var name = x3.name$2;
      if (this.calculator$Calculator$$stackSet$1.contains__O__Z(name)) {
        return (NaN)
      } else {
        this.calculator$Calculator$$stackSet$1 = $as_sci_Set(this.calculator$Calculator$$stackSet$1.$$plus__O__sc_Set(name));
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype = new $h_sr_AbstractFunction2();
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T__Lcalculator_Signal__Lcalculator_Signal = (function(name, signalExpr) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, name$1, signalExpr$1) {
    return (function() {
      $m_Lcalculator_Calculator$().calculator$Calculator$$stackSet$1 = $m_sci_Set$EmptySet$();
      $m_Lcalculator_Calculator$().calculator$Calculator$$stackSet$1 = $as_sci_Set($m_Lcalculator_Calculator$().calculator$Calculator$$stackSet$1.$$plus__O__sc_Set(name$1));
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(signalExpr$1.apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, name, signalExpr));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__O__O__O = (function(v1, v2) {
